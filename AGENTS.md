...
Wyvern Stream — Next.js 16 + TypeScript + Tailwind CSS 4
...
- Mocks only for external third-party systems (TMDB, Vidking providers)
...
- Style rules: `.editorconfig`, `eslint.config.mjs`
